  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <ToggleGroup 
            type="single" 
            value={viewCurrency} 
            onValueChange={(value) => value && onViewCurrencyChange(value as ViewCurrency)}
            className="bg-muted/50 p-1 rounded-lg"
          >
            <ToggleGroupItem 
              value="USD" 
              className="data-[state=on]:bg-financial-primary data-[state=on]:text-white font-semibold px-6"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {classTotals.slice(0, 2).map(({ class: assetClass, value, count }) => (

-- First drop all existing constraints to allow data migration
...
-- Migrate existing data from "Cash & other" to new structure
...
-- Now add the updated constraints with new asset classes
ALTER TABLE public.assets 
